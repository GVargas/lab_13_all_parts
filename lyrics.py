...
print("""How many times I gotta tell yall Im second to none? No magazine top ten cause Im negative one.\n""") * 4



print("How many times i gotta tell yall")
print("Im second to none?")
print("No magazine is top ten")
print("cause Im negative one.")


 
a = 'How many times i gotta tell yall '
b = 'Im second to none? '
c = 'No magazine is top ten '
d = 'cause Im negative one. '
print( a + b + c + d)